define(['angularAMD', 'scripts/requireHelper/requireNotification', 'scripts/services/httpService'], function (angularAMD) {
    'use strict';
    angularAMD.service('configService',
        function (httpService, Notification) {
            ...
            function getRaterDept() {
                var promise = httpService.postRemote('Manage', 'DictsService', 'GetDictsByApp', {
                    dicType: "RaterDept",
                    appId: appId
                }).then(function (data) {
                        var result = ""
            ...
            function getUserMenus() {
                var promise = httpService.postRemote('Open', 'OAuth', 'GetUserRight', {
                    token: httpService.getCookie("Tescomm_Access_Token"),
                    app: appId
                }).then(function (data) {
